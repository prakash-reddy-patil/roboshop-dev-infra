...
resource "aws_security_group_rule" "backend__alb_bastion" {
  type              = "ingress"
  security_group_id = local.backend_alb_sg_id # backend SG ID
...
resource "aws_security_group_rule" "bastion_laptop" {
  type              = "ingress"
  security_group_id = local.bastion_sg_id # backend SG ID
